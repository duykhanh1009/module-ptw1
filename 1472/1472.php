...
$url_path = str_replace('\\', '/', $url_path);
    ...
    $styles = $scss->compile('@import "1472.scss";');

    $css = fopen('css/1472.css','w');
...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/1472.css" rel="stylesheet" type="text/css" />
